...
public class Thread extends DataStoreObject {
	...
	public void initDataStoreObjectDescriptor(DataStoreService dss) {
		dss.initDataStoreObjectDescriptor(new DataStoreObjectDescriptor("org_nectarframework_www_thread", new DataStoreKey("threadId", DataStoreObjectDescriptor.Type.LONG, 8, false), new String[] { "threadId", "structureId", "authorUserId", "createdTimestamp", "lastEditTimestamp", "lastReplyTimestamp", "sticky", "flags", "subject", "message" }, new DataStoreObjectDescriptor.Type[] {DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.BYTE, DataStoreObjectDescriptor.Type.INT, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING}, Thread.class));
	}
