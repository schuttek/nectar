...
public class User extends DataStoreObject {
	...
	public void initDataStoreObjectDescriptor(DataStoreService dss) {
		dss.initDataStoreObjectDescriptor(new DataStoreObjectDescriptor("org_nectarframework_www_user", new DataStoreKey("id", DataStoreObjectDescriptor.Type.LONG, 8, false), new String[] { "id", "userType", "homeGroup", "login", "publicUserName", "permission", "lastUserIp", "registrationTimestamp", "emailAddress", "lastVisit", "localeLanguage", "localeCountry", "localeVariant", "options", "timezone", "avatar", "avatarType", "avatarWidth", "avatarHeight", "signature", "about", "registrationStatus" }, new DataStoreObjectDescriptor.Type[] {DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.BYTE, DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.LONG, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.BYTE, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.STRING, DataStoreObjectDescriptor.Type.BYTE}, new boolean[] {false, false, false, false, false, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true}, User.class));
	}
