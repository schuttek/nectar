 ...
 * https://github.com/apache/commons-io/blob/trunk/src/main/java/org/apache/
 * commons/io/output/ByteArrayOutputStream.java . The only difference is that this
...
public class FastByteArrayOutputStream extends OutputStream {
	 ...
	 *             has to now due to backwards compatibility)
	 */
	@Override
