...
//                Log.trace("[NanoHttpService]:safeClose "+closeable.getClass().getName()+" "+closeable.toString());
            }
        } catch (IOException e) {
            Log.fatal("Could not close", e);
        }
    }
     ...
     */
    protected static HashMap<String, List<String>> decodeParameters(HashMap<String, String> parms) {
        return decodeParameters(parms.get(NanoHttpService.QUERY_STRING_PARAMETER));
    }
     ...
     *         <code>List&lt;String&gt;</code> (a list of the values supplied).
     */
    protected static HashMap<String, List<String>> decodeParameters(String queryString) {
    ...
    /**
     * Hashtable MIME_TYPESping (String)FILENAME_EXTENSION -> (String)MIME_TYPE
     */
    protected final static HashMap<String, String> MIME_TYPES = new HashMap<String, String>();
    
    static {
		MIME_TYPES.put("123", "application/vnd.lotus-1-2-3");
		MIME_TYPES.put("3dml", "text/vnd.in3d.3dml");
		MIME_TYPES.put("3ds", "image/x-3ds");
		...
		MIME_TYPES.put("aam", "application/x-authorware-MIME_TYPES");
		MIME_TYPES.put("aas", "application/x-authorware-seg");
		MIME_TYPES.put("abw", "application/x-abiword");
		MIME_TYPES.put("ac", "application/pkix-attr-cert");
		...
		MIME_TYPES.put("ahead", "application/vnd.ahead.space");
		...
		MIME_TYPES.put("ait", "application/vnd.dvb.ait");
		...
		MIME_TYPES.put("blb", "application/x-blorb");
		MIME_TYPES.put("blorb", "application/x-blorb");
		...
		MIME_TYPES.put("c11amc", "application/vnd.cluetrust.cartomobile-config");
		MIME_TYPES.put("c11amz", "application/vnd.cluetrust.cartomobile-config-pkg");
		...
		MIME_TYPES.put("caf", "audio/x-caf");
		MIME_TYPES.put("cap", "application/vnd.tcpdump.pcap");
		MIME_TYPES.put("car", "application/vnd.curl.car");
		MIME_TYPES.put("cat", "application/vnd.ms-pki.seccat");
		MIME_TYPES.put("cb7", "application/x-cbr");
		MIME_TYPES.put("cba", "application/x-cbr");
		MIME_TYPES.put("cbr", "application/x-cbr");
		MIME_TYPES.put("cbt", "application/x-cbr");
		MIME_TYPES.put("cbz", "application/x-cbr");
		...
		MIME_TYPES.put("cdmia", "application/cdmi-capability");
		MIME_TYPES.put("cdmic", "application/cdmi-container");
		MIME_TYPES.put("cdmid", "application/cdmi-domain");
		MIME_TYPES.put("cdmio", "application/cdmi-object");
		MIME_TYPES.put("cdmiq", "application/cdmi-queue");
		...
		MIME_TYPES.put("cfs", "application/x-cfs-compressed");
		...
		MIME_TYPES.put("cryptonote", "application/vnd.rig.cryptonote");
		...
		MIME_TYPES.put("dgc", "application/x-dgc-compressed");
		...
		MIME_TYPES.put("dmp", "application/vnd.tcpdump.pcap");
		...
		MIME_TYPES.put("dvb", "video/vnd.dvb.file");
		...
		MIME_TYPES.put("emf", "application/x-msmetafile");
		MIME_TYPES.put("eml", "message/rfc822");
		MIME_TYPES.put("emma", "application/emma+xml");
		MIME_TYPES.put("emz", "application/x-msmetafile");
		...
		MIME_TYPES.put("esa", "application/vnd.osgi.subsystem");
		...
		MIME_TYPES.put("fcdt", "application/vnd.adobe.formscentral.fcdt");
		MIME_TYPES.put("fcs", "application/vnd.isac.fcs");
		...
		MIME_TYPES.put("flac", "audio/x-flac");
		...
		MIME_TYPES.put("fxp", "application/vnd.adobe.fxp");
		MIME_TYPES.put("fxpl", "application/vnd.adobe.fxp");
		...
		MIME_TYPES.put("gam", "application/x-tads");
		MIME_TYPES.put("gbr", "application/rpki-ghostbusters");
		...
		MIME_TYPES.put("gml", "application/gml+xml");
		...
		MIME_TYPES.put("gxf", "application/gxf");
		...
		MIME_TYPES.put("hal", "application/vnd.hal+xml");
		...
		MIME_TYPES.put("i2g", "application/vnd.intergeo");
		...
		MIME_TYPES.put("igm", "application/vnd.insors.igm");
		...
		MIME_TYPES.put("ink", "application/inkml+xml");
		MIME_TYPES.put("inkml", "application/inkml+xml");
		MIME_TYPES.put("install", "application/x-install-instructions");
		MIME_TYPES.put("in", "text/plain");
		MIME_TYPES.put("iota", "application/vnd.astraea-software.iota");
		...
		MIME_TYPES.put("jsonml", "application/jsonml+json");
		...
		MIME_TYPES.put("lasxml", "application/vnd.las.las+xml");
		...
		MIME_TYPES.put("lha", "application/x-lzh-compressed");
		...
		MIME_TYPES.put("lnk", "application/x-ms-shortcut");
		...
		MIME_TYPES.put("mads", "application/mads+xml");
		...
		MIME_TYPES.put("mar", "application/octet-stream");
		...
		MIME_TYPES.put("meta4", "application/metalink4+xml");
		MIME_TYPES.put("metalink", "application/metalink+xml");
		MIME_TYPES.put("me", "text/troff");
		MIME_TYPES.put("mets", "application/mets+xml");
		MIME_TYPES.put("mfm", "application/vnd.mfmp");
		MIME_TYPES.put("mft", "application/rpki-manifest");
		MIME_TYPES.put("mgp", "application/vnd.osgeo.MIME_TYPESguide.package");
		MIME_TYPES.put("mgz", "application/vnd.proteus.magazine");
		MIME_TYPES.put("mid", "audio/midi");
		MIME_TYPES.put("midi", "audio/midi");
		MIME_TYPES.put("mie", "application/x-mie");
		...
		MIME_TYPES.put("mk3d", "video/x-matroska");
		MIME_TYPES.put("mka", "audio/x-matroska");
		MIME_TYPES.put("mks", "video/x-matroska");
		...
		MIME_TYPES.put("mods", "application/mods+xml");
		MIME_TYPES.put("movie", "video/x-sgi-movie");
		MIME_TYPES.put("mov", "video/quicktime");
		MIME_TYPES.put("mp21", "application/mp21");
		...
		MIME_TYPES.put("mrcx", "application/marcxml+xml");
		...
		MIME_TYPES.put("ntf", "application/vnd.nitf");
		MIME_TYPES.put("nzb", "application/x-nzb");
		...
		MIME_TYPES.put("obj", "application/x-tgif");
		...
		MIME_TYPES.put("omdoc", "application/omdoc+xml");
		...
		MIME_TYPES.put("opml", "text/x-opml");
		...
		MIME_TYPES.put("p8", "application/pkcs8");
		...
		MIME_TYPES.put("pbm", "image/x-portable-bitMIME_TYPES");
		MIME_TYPES.put("pcap", "application/vnd.tcpdump.pcap");
		...
		MIME_TYPES.put("pgm", "image/x-portable-grayMIME_TYPES");
		...
		MIME_TYPES.put("pnm", "image/x-portable-anyMIME_TYPES");
		...
		MIME_TYPES.put("ppm", "image/x-portable-pixMIME_TYPES");
		...
		MIME_TYPES.put("pskcxml", "application/pskc+xml");
		...
		MIME_TYPES.put("rip", "audio/vnd.rip");
		MIME_TYPES.put("ris", "application/x-research-info-systems");
		...
		MIME_TYPES.put("roa", "application/rpki-roa");
		...
		MIME_TYPES.put("sfv", "text/x-sfv");
		MIME_TYPES.put("sgi", "image/sgi");
		...
		MIME_TYPES.put("sid", "image/x-mrsid-image");
		MIME_TYPES.put("sig", "application/pgp-signature");
		MIME_TYPES.put("sil", "audio/silk");
		...
		MIME_TYPES.put("sm", "application/vnd.stepmania.stepchart");
		...
		MIME_TYPES.put("smv", "video/x-smv");
		MIME_TYPES.put("smzip", "application/vnd.stepmania.package");
		...
		MIME_TYPES.put("sub", "image/vnd.dvb.subtitle");
		MIME_TYPES.put("sub", "text/vnd.dvb.subtitle");
		...
		MIME_TYPES.put("svc", "application/vnd.dvb.service");
		...
		MIME_TYPES.put("t3", "application/x-t3vm-image");
		MIME_TYPES.put("taglet", "application/vnd.mynfc");
		...
		MIME_TYPES.put("tei", "application/tei+xml");
		MIME_TYPES.put("teicorpus", "application/tei+xml");
		...
		MIME_TYPES.put("tfi", "application/thraud+xml");
		MIME_TYPES.put("tfm", "application/x-tex-tfm");
		MIME_TYPES.put("tga", "image/x-tga");
		...
		MIME_TYPES.put("tsd", "application/timestamped-data");
		...
		MIME_TYPES.put("ttl", "text/turtle");
		MIME_TYPES.put("twd", "application/vnd.simtech-mindMIME_TYPESper");
		MIME_TYPES.put("twds", "application/vnd.simtech-mindMIME_TYPESper");
		...
		MIME_TYPES.put("ulx", "application/x-glulx");
		...
		MIME_TYPES.put("uva", "audio/vnd.dece.audio");
		MIME_TYPES.put("uvd", "application/vnd.dece.data");
		MIME_TYPES.put("uvf", "application/vnd.dece.data");
		MIME_TYPES.put("uvg", "image/vnd.dece.graphic");
		MIME_TYPES.put("uvh", "video/vnd.dece.hd");
		MIME_TYPES.put("uvi", "image/vnd.dece.graphic");
		MIME_TYPES.put("uvm", "video/vnd.dece.mobile");
		MIME_TYPES.put("uvp", "video/vnd.dece.pd");
		MIME_TYPES.put("uvs", "video/vnd.dece.sd");
		MIME_TYPES.put("uvt", "application/vnd.dece.ttml+xml");
		MIME_TYPES.put("uvu", "video/vnd.uvvu.mp4");
		MIME_TYPES.put("uvva", "audio/vnd.dece.audio");
		MIME_TYPES.put("uvvd", "application/vnd.dece.data");
		MIME_TYPES.put("uvvf", "application/vnd.dece.data");
		MIME_TYPES.put("uvvg", "image/vnd.dece.graphic");
		MIME_TYPES.put("uvvh", "video/vnd.dece.hd");
		MIME_TYPES.put("uvvi", "image/vnd.dece.graphic");
		MIME_TYPES.put("uvvm", "video/vnd.dece.mobile");
		MIME_TYPES.put("uvvp", "video/vnd.dece.pd");
		MIME_TYPES.put("uvvs", "video/vnd.dece.sd");
		MIME_TYPES.put("uvvt", "application/vnd.dece.ttml+xml");
		MIME_TYPES.put("uvvu", "video/vnd.uvvu.mp4");
		MIME_TYPES.put("uvv", "video/vnd.dece.video");
		MIME_TYPES.put("uvvv", "video/vnd.dece.video");
		MIME_TYPES.put("uvvx", "application/vnd.dece.unspecified");
		MIME_TYPES.put("uvvz", "application/vnd.dece.zip");
		MIME_TYPES.put("uvx", "application/vnd.dece.unspecified");
		MIME_TYPES.put("uvz", "application/vnd.dece.zip");
		MIME_TYPES.put("vcard", "text/vcard");
		...
		MIME_TYPES.put("vob", "video/x-ms-vob");
		...
		MIME_TYPES.put("wdp", "image/vnd.ms-photo");
		...
		MIME_TYPES.put("wmz", "application/x-msmetafile");
		...
		MIME_TYPES.put("x3db", "model/x3d+binary");
		MIME_TYPES.put("x3dbz", "model/x3d+binary");
		MIME_TYPES.put("x3d", "model/x3d+xml");
		MIME_TYPES.put("x3dv", "model/x3d+vrml");
		MIME_TYPES.put("x3dvz", "model/x3d+vrml");
		MIME_TYPES.put("x3dz", "model/x3d+xml");
		MIME_TYPES.put("xaml", "application/xaml+xml");
		...
		MIME_TYPES.put("xbm", "image/x-xbitMIME_TYPES");
		MIME_TYPES.put("xdf", "application/xcap-diff+xml");
		...
		MIME_TYPES.put("xlf", "application/x-xliff+xml");
		...
		MIME_TYPES.put("xpl", "application/xproc+xml");
		MIME_TYPES.put("xpm", "image/x-xpixMIME_TYPES");
		...
		MIME_TYPES.put("yang", "application/yang");
		MIME_TYPES.put("yin", "application/yin+xml");
		MIME_TYPES.put("z1", "application/x-zmachine");
		MIME_TYPES.put("z2", "application/x-zmachine");
		MIME_TYPES.put("z3", "application/x-zmachine");
		MIME_TYPES.put("z4", "application/x-zmachine");
		MIME_TYPES.put("z5", "application/x-zmachine");
		MIME_TYPES.put("z6", "application/x-zmachine");
		MIME_TYPES.put("z7", "application/x-zmachine");
		MIME_TYPES.put("z8", "application/x-zmachine");
		...
		MIME_TYPES.put("zmm", "application/vnd.handheld-entertainment+xm");
