...
public class SimpleHttpRequestService extends Service implements Container {
	...
	private String defaultOutput = "xml";
	...
	protected boolean init() {
		...
		mimeTypesByExtension = buildMimeTypesMap();
		return true;
	}
	...
	protected boolean shutdown() {
		try {
			...
			Log.fatal("SimpleHttpService: Couldn't close listening connection.", e);
			return false;
		}
		return true;
	}
	...
	public int getStaticFileBufferSize() {
		return staticFileBufferSize;
	}
}
