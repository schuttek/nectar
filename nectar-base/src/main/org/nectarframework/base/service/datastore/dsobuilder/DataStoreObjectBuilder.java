	...
	private void run(String inputFile, String outputDir) {
		try {
			...
			for (Element dsoElm : dsoElmList) {
				...
				pw.println();
				pw.println("import nectar.base.service.ServiceRegister;");
				pw.println("import nectar.base.service.datastore.DataStoreKey;");
				pw.println("import nectar.base.service.datastore.DataStoreObject;");
				pw.println("import nectar.base.service.datastore.DataStoreObjectDescriptor;");
				pw.println("import nectar.base.service.datastore.DataStoreService;");
				pw.println("");
				...
				pw.println("		DataStoreService dss = (DataStoreService) ServiceRegister.getServiceByClassName(DataStoreService.class.getName());");
				pw.println("		return (" + className + ") dss.loadDSO(dss.getDataStoreObjectDescriptor(" + className + ".class), key);");
				pw.println("	}");
				pw.println("	");
